...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($pnum) || empty($venue) || empty($price) || empty($checkin) || empty($checkout)) {
        ...
        $values = array($name, $pnum, $venue, $price, $checkin, $checkout);
        $datatypes = "ssssss";
