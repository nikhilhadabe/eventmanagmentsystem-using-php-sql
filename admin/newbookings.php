...
<body class="bg-light">
    ...
    <div class="modal fade" id="assignevent" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form id="assigneventform">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Assign Event</h5>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label fw-bold">event number</label>
                            <input type="text" name="eventno" id="featurenameinp" class="form-control shadow-none"
                                required>
                        </div>
                        <span class="badge bg-light text-dark mb-3 text-wrap lh-base">
                            Note: Assign Event only when user has been arrived.
                        </span>
